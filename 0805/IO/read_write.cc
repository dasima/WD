...
#include <iostream>
using namespace std;
ssize_t ReadWrite::readn(int fd, void* usrbuf, size_t n)
{
...
ssize_t ReadWrite::writen(int fd, void* usrbuf, size_t n)
{
...
ssize_t ReadWrite::recv_peek(int sockfd, void* buf, size_t len)
{
    int nread;
    while(1)
    {
...
ssize_t ReadWrite::readline(int fd, void* usrbuf, size_t maxline)
{
    int nread;//一次IO读取的数量
